                        ...
                        <form class="forminscr" method="POST" action="">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <input class="ml-2 mb-3" type="text" placeholder="Votre nom" id="nom" name="lastname" value="<?php if (isset($nom)) {
                                                                                                                                            echo $nom;
                                                                                                                                        } ?>">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input class="ml-2 mb-3" type="text" placeholder="Votre prénom" id="prénom" name="firstname" value="<?php if (isset($prénom)) {
                                                                                                                                                echo $prénom;
                                                                                                                                            } ?>">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td align="center">
                                        <input class="ml-2 mb-3" type="email" placeholder="Votre Mail" id="mail" name="mail" value="<?php if (isset($mail)) {
                                                                                                                                        echo $mail;
                                                                                                                                    } ?>">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input class="ml-2 mb-3" type="email" placeholder="Confirmer adresse Mail" id="mail2" name="mail2" value="<?php if (isset($mail2)) {
                                                                                                                                                        echo $mail2;
                                                                                                                                                    } ?>">
                                    </td>
                                </tr>
